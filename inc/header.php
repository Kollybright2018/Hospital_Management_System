  ...
  <nav class="navbar navbar-expand-lg navabr-info bg-info">
  	...
  	<ul class="navbar-nav">
  		<?php if (isset($_SESSION['username'])){
  			...
  			echo '
  			<li class="nav-item"><a class="nav-link text-white" href="index.php">'. $user .'</a></li>
        ...
        echo '
        <li class="nav-item"><a class="nav-link text-white" href="patient.php">'. $patient .'</a></li>
        <li class="nav-item"><a class="nav-link text-white" href="logout.php">Logout</a></li>
        ...
        <li class="nav-item"><a class="nav-link text-white" href="adminlogin.php">Admin</a></li>
  	     ...
  	     <li class="nav-item"><a class="nav-link text-white" href="patient/patientlogin.php">Patient</a></li>
  			';
