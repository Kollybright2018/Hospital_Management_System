			...
			<div class="col-md-12">
				<div class="row">
					...
					<div class="col-md-4 mx-1 shadow ">
						...
						<a class="" href="patient/patientreg.php"> <button class="btn btn-success ml-3"> Create Account </button></a>
					</div>
					...
					<div class="col-md-4 mx-1 shadow ">
						...
						<a class="" href="doctor/doctorreg.php"> <button class="btn btn-success ml-5"> Apply Now !!! </button></a>
					</div>
				</div>
